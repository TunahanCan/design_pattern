package com.can.demo.structural.flyweight;

import com.can.structural.flyweight.Forest;
import com.can.structural.flyweight.TreeFactory;

/**
 * Executable composition root for the Flyweight example.
 *
 * <p>Reusable context, flyweight, and factory types remain in
 * {@code com.can.structural.flyweight}.</p>
 */
